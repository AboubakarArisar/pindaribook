...
const Navbar = () => {
  return (
    <>
      <header className='p-4 shadow-xl bg-black/20 text-white backdrop-blur-lg'>
        <nav className='flex justify-around items-center gap-4'>
          ...
          <div className='w-1/3 flex justify-center items-center'>
            <CustomButton className='border-yellow-400 hover:bg-yellow-400 hover:text-black hover:shadow-lg transition duration-300'>
              Login
            </CustomButton>
          </div>
        </nav>
